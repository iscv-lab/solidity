...
export interface ListBusinessAppointmentInterface extends utils.Interface {
  functions: {
  ...
  encodeFunctionData(
    ...
    values: [BusinessAppointmentStruct]
  ): string;
  encodeFunctionData(
...
export interface AddEventObject {
  item: BusinessAppointmentStructOutput;
}
export type AddEvent = TypedEvent<
  [BusinessAppointmentStructOutput],
  AddEventObject
>;
...
export interface ListBusinessAppointment extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: ListBusinessAppointmentInterface;
  ...
  functions: {
    add(
      item: BusinessAppointmentStruct,
  ...
  getAll(overrides?: CallOverrides): Promise<BusinessAppointmentStructOutput[]>;
